...
Based on [@wagmi/core](https://wagmi.sh/core/getting-started) and [viem](https://viem.sh/), RabbyKit can be easily integrated into [React](https://react.dev/), [Vue](https://vuejs.org/), or other frameworks.
