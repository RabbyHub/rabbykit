...
```sh npm2yarn
npm i @rabby-wallet/rabbykit wagmi/core@1.4.13 viem@1.21.4
```
...
1. [wagmi](https://wagmi.sh/core/providers/public#return-value) recommends using other provider packages such as [Infura](https://www.infura.io) or [Alchemy](https://www.alchemy.com/) depending on the specific network requirements of your dApp. These providers offer reliable infrastructure and can be chosen based on your specific needs.
